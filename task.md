...
- [x] Ajustar cálculo do WhatsApp: faturamento bruto = total receitas + despesas + vales, total de saídas = despesas + vales, saldo líquido = bruto - saídas.
- [x] Controle de cache e versionamento (Cache-Busting)
  - [x] Incrementar versão do script (`app.js?v=31.0`) e estilo (`style.css?v=20.0`) em `index.html`
  - [x] Atualizar versão do Service Worker (`sw.js`) para `fechou-cache-v48`
