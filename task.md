...
- [x] Corrigir erro de conexão ao cadastrar operadores provisionando uma nova base de dados no Upstash Redis
- [x] Controle de cache e versionamento (Cache-Busting)
  - [x] Incrementar versão do script (`app.js?v=32.0`) e estilo (`style.css?v=20.0`) em `index.html`
  - [x] Atualizar versão do Service Worker (`sw.js`) para `fechou-cache-v49`
